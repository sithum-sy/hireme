                        ...
                        <thead className="table-light">
                            <tr>
                                <th 
                                    ...
                                    onClick={() => onSort && onSort('quote_number')}
                                >
                                    Quote # {getSortIcon('quote_number')}
                                </th>
                                <th 
                                    className="cursor-pointer" 
                                    onClick={() => onSort && onSort('service_title')}
                                >
                                    Service {getSortIcon('service_title')}
                                </th>
                                <th 
                                    className="cursor-pointer" 
                                    onClick={() => onSort && onSort('client_name')}
                                >
                                    Client {getSortIcon('client_name')}
                                </th>
                                <th 
                                    className="cursor-pointer" 
                                    onClick={() => onSort && onSort('requested_date')}
                                >
                                    Requested Date {getSortIcon('requested_date')}
                                </th>
                                <th 
                                    className="cursor-pointer" 
                                    onClick={() => onSort && onSort('quoted_price')}
                                >
                                    Your Quote {getSortIcon('quoted_price')}
                                </th>
                                <th 
                                    className="cursor-pointer" 
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            {quote.requested_time && (
                                                <div className="small text-muted">
                                                    {formatTime(quote.requested_time)}
                                                </div>
                                            )}
                                        </div>
                                    </td>
