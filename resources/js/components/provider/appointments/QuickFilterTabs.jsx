...
const QuickFilterTabs = ({
    ...
    const filterOptions = [
        ...
        },
        {
            ...
            count: appointmentCounts.reschedule_requests || 0,
            color: "warning",
        },
        {
            key: "all",
    ...
    return (
        <div className="quick-filter-tabs">
            ...
            <div className="tabs-container">
                {filterOptions.map((option) => (
                    ...
                    >
                        ...
                        {option.key === "reschedule_requests" &&
                            option.count > 0 && (
                                <div className="urgent-badge">Needs Review</div>
                            )}
                    </button>
                ))}
            </div>
            ...
            <style jsx>{`
                ...
                .filter-tab.warning:hover .tab-count {
