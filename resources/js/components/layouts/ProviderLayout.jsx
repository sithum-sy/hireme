            ...
            <div className="dashboard-container">
                ...
                >
                    <div className="content-container">
                        ...
                        {/* Performance Summary (Dashboard only) */}
                        {/* {location.pathname === "/provider/dashboard" && (
                                    ...
                                    <div className="dashboard-card">
                                        ...
                                        <div className="dashboard-card-body">
                                            <div className="performance-card">
                                                <div
                                                    className={`performance-icon ${performanceIndicators.responseRate.status}`}
                                                >
                                                    <i className="fas fa-clock"></i>
                                                </div>
                                            ...
                                            <div className="performance-card">
                                                <div
                                                    className={`performance-icon ${performanceIndicators.rating.status}`}
                                                >
                                                    <i className="fas fa-star"></i>
                                                </div>
                                                <div className="performance-content">
                                            ...
                                            <div className="performance-card">
                                                <div className="performance-icon excellent">
