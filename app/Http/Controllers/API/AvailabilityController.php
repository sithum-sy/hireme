        ...
        try {
            ...
            return response()->json([
                ...
                'data' => [
                    ...
                    'start_time' => $blockedTime->start_time ? (is_string($blockedTime->start_time) ? substr($blockedTime->start_time, 0, 5) : $blockedTime->start_time->format('H:i')) : null,
                    'end_time' => $blockedTime->end_time ? (is_string($blockedTime->end_time) ? substr($blockedTime->end_time, 0, 5) : $blockedTime->end_time->format('H:i')) : null,
        ...
        try {
            ...
            $formattedBlockedTimes = $blockedTimes->map(function ($blocked) {
                return [
                    ...
                    'start_time' => $blocked->start_time ? (is_string($blocked->start_time) ? substr($blocked->start_time, 0, 5) : $blocked->start_time->format('H:i')) : null,
                    'end_time' => $blocked->end_time ? (is_string($blocked->end_time) ? substr($blocked->end_time, 0, 5) : $blocked->end_time->format('H:i')) : null,
